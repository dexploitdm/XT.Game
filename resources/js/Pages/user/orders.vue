            ...
            <div class="layout">
                <div class="layout-box">
                    <div class="bg-w xt-box xt-order">
                        ...
                        <div class="xt-order-block">
                            <div class="xt-order-info">
                                <p>Чтобы активировать код игры:</p>
                                <ul>
                                    <li>Установите на компьютер или телефон VPN приложение.
                                        Для телефона рекомендуем - Urban Vpn, VPN.lat, Turkey VPN, Windscribe, Seed4me, X-VPN, Express VPN, Touch VPN, Free VPN и др.
                                        Для компьютера подходят Urban VPN, Hola VPN или браузер со встроенным VPN или установленным плагином.</li>
                                    <li>Авторизуйтесь на сайте www.xbox.com. Далее выберите в меню сайта "Игры" - "Все игры" - "Активировать код" Перекинет на страницу redeem.microsoft.com.</li>
                                    <li>Запустите установленную программу VPN и выберите регион Аргентина (или Турция или Бразилия или США или Колумбия или Индия - уточните у продавца регион где была приобретена игра). Скопируйте в поле или введите присланный Вам код и нажмите Далее! (⚠Дефисы вводить не нужно, система позаботится о них автоматически)</li>
                                </ul>
                                ВСЕ ГОТОВО!
                            </div>
